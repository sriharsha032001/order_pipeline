...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, OrderEvent> producerFactory(org.springframework.core.env.Environment env) {
        ...
        // optional: ensure idempotent writes in producer (not required for this POC)
